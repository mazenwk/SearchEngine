...
/// <remarks> Referenced from: https://stackoverflow.com/a/4053879 </remarks>
 ...
 void page::cout_colored(std::string text, color_code code, bool do_endl)
{
...
/// <remarks> Referenced from: https://stackoverflow.com/a/6487534 </remarks>
 ...
 void page::set_cursor_pos(short x, short y)
{
	COORD pos = { x, y };
...
/// <param name="word">The word to output</param>
 ...
 void page::cout_stylized_word(const std::string& word) {
...
/// <returns></returns>
 ...
 std::vector<std::string> page::get_stylized_letter(const char& c) {
