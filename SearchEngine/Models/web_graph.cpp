...
/// <returns>The graph nodes map</returns>
 ...
 std::unordered_map<std::string, web_graph_node>& web_graph::get_nodes_map() { return nodes_map_; }
...
/// <param name="nodes">The new graph nodes</param>
 ...
 void web_graph::set_nodes(const std::vector<web_graph_node>& nodes) {
	for (auto node : nodes) {
...
/// <param name="page">The webpage to add</param>
 ...
 void web_graph::add_webpage_node(const webpage page) {
...
/// <param name="u">The webpage url</param>
 ...
 void web_graph::add_webpage_node(const std::string u) {
...
/// <param name="v">Node 2 URL</param>
 ...
 void web_graph::add_webpage_edge(const std::string u, const std::string v) {
...
/// <returns>The webpage info (page object)</returns>
 ...
 webpage& web_graph::get_webpage_info(const std::string& url) {
...
/// <param name="iterations">The number of iterations to go through while calculating the page ranks</param>
 ...
 void web_graph::calculate_page_ranks(int iterations) {
...
/// </summary>
 ...
 void web_graph::print_web_graph()
{
	for (const auto kvp : nodes_map_) {
...
/// <returns>True if the node exists, false otherwise</returns>
 ...
 bool web_graph::does_webpage_node_exist(std::string u) {
...
/// <returns>True if an edge exists, false otherwise</returns>
 ...
 bool web_graph::does_webpage_edge_exist(const std::string& u, const std::string& v) {
	bool exists = false;
